...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.created_by'
        db.alter_column('item_item', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    def backwards(self, orm):

        # Changing field 'Item.created_by'
        db.alter_column('item_item', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.CustomUser']))
    models = {
        'auth.group': {
